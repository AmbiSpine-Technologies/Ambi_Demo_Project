...
//           <input className="form-check-input ps-1" type="radio" name="Audio" id="Audio" defaultChecked ></input>
//           <label className="form-check-label " htmlFor="Audio">
//             <p className='fs-5'>Audio</p>
//           </label>
//       </div>
//         <div className=" ps-2  form-check ">
//           <input className="form-check-input ps-1" type="radio" name="video" id="video" defaultChecked ></input>
...
//        <button className="btn btn-primary ps-3">Start</button>
//       </div>
//    </div>
//   </div>
//   );
